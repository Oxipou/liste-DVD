...
- Même si c'est plutôt connu, je rappelle que *⌘ + F* (ou *ctrl + F* sur Windows/Linux) permet, sur ordinateur, de rechercher un ou des mots dans la liste. Pour les téléphones voici des vidéos pour faire la même chose sur iOS (Safari) ou Android (Google Chrome) [ici](./assets/tutos/recherche-sur-telephone/README.md) (la première vidéo montre plein d'exemples d'utilisation alors que la deuxième ne montre que comment utiliser l'outil recherche).
